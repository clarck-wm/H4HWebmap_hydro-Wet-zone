...
function exp_label_SAPM_H4H_AREAS_2_eval_expression(context) {
    // NOM || '\n' || ' Protected Area'
...
function exp_label_LimiteCommunes6Sites_3_eval_expression(context) {
    // 'CR de ' || COMMUNE

    var feature = context.feature;
    
    if (feature.properties) {
        return ('CR de ' + feature.get('COMMUNE') );
    } else {
        return ('CR de ' + feature.get('COMMUNE') );
    }
}